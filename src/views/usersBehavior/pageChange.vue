        ...
        <el-card>
            ...
            <div class="contentform">
                <el-table :data="tableData.slice((currentPage - 1) * pageSize, currentPage * pageSize)"
                    ...
                    <el-table-column prop="from" label="来源地址" width="400" />
                    <el-table-column prop="to" label="访问地址" width="400" />
                    <el-table-column prop="start" label="项目运行(ms)" />
                    <el-table-column prop="time" fixed="right" label="日期" sortable width="180" />
                </el-table>
...
// 获取项目用户信息
const getProjectUserInfoAgain = async () => {
    let parms = {
    ...
    const result = newData.filter(item => item.type !== 'page-access-duration');
